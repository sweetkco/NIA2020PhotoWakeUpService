...
class SMPLRenderer:
    ...
    def __init__(self,
                 img_size=224,
                 flength=500.,
                 face_path='/Users/choehanjoon/PycharmProjects/HMR/smpl_faces.npy'):
    ...
    def __call__(self,
        ...
        use_cam = ProjectPoints(f=cam[0]*np.ones(2),rt=np.zeros(3),
        t=np.zeros(3),k=np.zeros(5),c=cam[1:3])
