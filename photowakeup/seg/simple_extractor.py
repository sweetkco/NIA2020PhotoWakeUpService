...
def get_arguments():
    ...
    parser.add_argument("--model-restore", type=str, default='./model/exp-schp-201908301523-atr.pth', help="restore pretrained model parameters.")
    parser.add_argument("--gpu", type=str, default='0', help="choose gpu device.")
    parser.add_argument("--input-dir", type=str, default='./data', help="path of input image folder.")
    parser.add_argument("--output-dir", type=str, default='./output/atr', help="path of output image folder.")
...
def main():
    ...
    with torch.no_grad():
        for idx, batch in enumerate(tqdm(dataloader)):
            ...
            #gray = cv2.cvtColor( np.array(output_img), cv2.COLOR_RGB2GRAY)
            ...
            # cv2.imwrite(os.path.join(args.output_dir, img_name[:-4] + '.png'),rgba)
            # cv2.imwrite(os.path.join(args.output_dir, img_name[:-4] + '1.png'), img)
