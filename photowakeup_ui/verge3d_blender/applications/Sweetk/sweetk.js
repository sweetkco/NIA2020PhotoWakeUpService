...
(function() {
    ...
    var sceneURL = params.load ? params.load : '__URL__sweetk.gltf'.replace('__URL__', '');
    if (!sceneURL) {
...
function fire_ajax_submit() {
    ...
    var hostname = window.location.hostname;//"192.168.35.82"; //window.location.hostname ;
    console.log("hostname=>" + window.location.hostname);
    $.ajax({
        type : "POST",
        enctype : 'multipart/form-data',
        url : "http://"+ hostname + ":12002/file/upload/multi",
        data : data,
