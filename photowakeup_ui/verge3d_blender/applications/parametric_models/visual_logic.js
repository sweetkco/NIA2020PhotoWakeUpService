 ...
 * Fri Nov 13 2020 20:14:34 GMT+0300 (Moscow Standard Time)
...
registerOnDrag('mechanism_slider_height', false, function() {}, function() {
  dragMove('mechanism_slider_height', 'Z', 'i7yGLY1X#J^Zu{)^?NVL', 'NmKJ1,HQ7j!n0BbwuO#Q');
  setMorphFactor('mechanism_part', 'move_top', (getObjTransform('mechanism_slider_height', 'position', 'z') - 0.38) * 2);
  setObjTransform(['mechanism_slider_width_right', 'mechanism_slider_width_left', 'mechanism_slider_depth_left', 'mechanism_slider_depth_right'], 'position', '', '', (toFixedPoint(getObjTransform('mechanism_slider_height', 'position', 'z'), 3) - 0.38) / 2, false);
  objConstraintAddLimit('Limit Location', 'hole_controller_right', 'POS_Z', -0.25 - (getObjTransform('mechanism_slider_height', 'position', 'z') - 0.38), 0.25);
  objConstraintAddLimit('Limit Location', 'hole_controller_left', 'POS_Z', -0.25 - (getObjTransform('mechanism_slider_height', 'position', 'z') - 0.38), 0.25);
  setMorphFactor('mechanism_part', 'move_holes', (getObjTransform('hole_controller_right', 'position', 'z') - 0.25) * -2);
}, function() {}, 'NmKJ1,HQ7j!n0BbwuO#Q');
registerOnDrag('mechanism_slider_width_right', false, function() {}, function() {
  dragMove('mechanism_slider_width_right', 'X', 'OlDaSi^=rWZHFHkU9#;8', 'xc@q9TIzFt1GwhjYpa%!');
  setMorphFactor('mechanism_part', 'move_sides', (getObjTransform('mechanism_slider_width_right', 'position', 'x') - 0.25) * 8);
  setObjTransform('mechanism_slider_width_left', 'position', getObjTransform('mechanism_slider_width_right', 'position', 'x') * -1, '', '', false);
  setObjTransform('mechanism_slider_depth_right', 'position', getObjTransform('mechanism_slider_width_right', 'position', 'x') - 0.025, '', '', false);
  setObjTransform('mechanism_slider_depth_left', 'position', (getObjTransform('mechanism_slider_width_right', 'position', 'x') - 0.025) * -1, '', '', false);
  setObjTransform('hole_controller_right', 'position', getObjTransform('mechanism_slider_width_right', 'position', 'x'), '', '', false);
  setObjTransform('hole_controller_left', 'position', getObjTransform('mechanism_slider_width_right', 'position', 'x') * -1, '', '', false);
}, function() {}, 'xc@q9TIzFt1GwhjYpa%!');
registerOnDrag('mechanism_slider_width_left', false, function() {}, function() {
  dragMove('mechanism_slider_width_left', 'X', '4sWX93({[Zr/028_xbtw', 'L*ZXYvXmNpKml`6+7{NZ');
  setMorphFactor('mechanism_part', 'move_sides', (getObjTransform('mechanism_slider_width_left', 'position', 'x') + 0.25) * 8 * -1);
  setObjTransform('mechanism_slider_width_right', 'position', getObjTransform('mechanism_slider_width_left', 'position', 'x') * -1, '', '', false);
  setObjTransform('mechanism_slider_depth_left', 'position', getObjTransform('mechanism_slider_width_left', 'position', 'x') + 0.025, '', '', false);
  setObjTransform('mechanism_slider_depth_right', 'position', (getObjTransform('mechanism_slider_width_left', 'position', 'x') + 0.025) * -1, '', '', false);
  setObjTransform('hole_controller_left', 'position', getObjTransform('mechanism_slider_width_left', 'position', 'x'), '', '', false);
  setObjTransform('hole_controller_right', 'position', getObjTransform('mechanism_slider_width_left', 'position', 'x') * -1, '', '', false);
}, function() {}, 'L*ZXYvXmNpKml`6+7{NZ');
registerOnDrag('mechanism_slider_depth_right', false, function() {}, function() {
  dragMove('mechanism_slider_depth_right', 'Y', 'U5EX,*%FaE_V_?pyjZAu', 'QP4C9WWf/G*7^i02;yQ+');
  setMorphFactor('mechanism_part', 'move_front', Math.abs((getObjTransform('mechanism_slider_depth_right', 'position', 'y') + 0.125) * 4));
  setObjTransform(['mechanism_slider_width_right', 'mechanism_slider_width_left'], 'position', '', (getObjTransform('mechanism_slider_depth_right', 'position', 'y') + 0.125) / 2, '', false);
  setObjTransform('mechanism_slider_depth_left', 'position', '', getObjTransform('mechanism_slider_depth_right', 'position', 'y'), '', false);
  setObjTransform('hole_controller_right', 'position', '', getObjTransform('mechanism_slider_width_right', 'position', 'y'), '', false);
  setObjTransform('hole_controller_left', 'position', '', getObjTransform('mechanism_slider_width_right', 'position', 'y'), '', false);
}, function() {}, 'QP4C9WWf/G*7^i02;yQ+');
registerOnDrag('mechanism_slider_depth_left', false, function() {}, function() {
  dragMove('mechanism_slider_depth_left', 'Y', 'H9p8-NtvgH^=SNF{nXR:', '5ES+mOB-ugKBT)SR}IOo');
  setMorphFactor('mechanism_part', 'move_front', Math.abs((getObjTransform('mechanism_slider_depth_left', 'position', 'y') + 0.125) * 4));
  setObjTransform(['mechanism_slider_width_right', 'mechanism_slider_width_left'], 'position', '', (getObjTransform('mechanism_slider_depth_left', 'position', 'y') + 0.125) / 2, '', false);
  setObjTransform('mechanism_slider_depth_right', 'position', '', getObjTransform('mechanism_slider_depth_left', 'position', 'y'), '', false);
  setObjTransform('hole_controller_right', 'position', '', getObjTransform('mechanism_slider_width_left', 'position', 'y'), '', false);
  setObjTransform('hole_controller_left', 'position', '', getObjTransform('mechanism_slider_width_left', 'position', 'y'), '', false);
}, function() {}, '5ES+mOB-ugKBT)SR}IOo');

registerOnDrag('hole_controller_right', false, function() {}, function() {
  dragMove('hole_controller_right', 'Z', 'X{*({y^^wUV7rl{wKoLN', 'fkXg$n{%emz6(*-`G~g`');
  setMorphFactor('mechanism_part', 'move_holes', (getObjTransform('hole_controller_right', 'position', 'z') - 0.25) * -2);
  setObjTransform('hole_controller_left', 'position', '', '', getObjTransform('hole_controller_right', 'position', 'z'), false);
}, function() {}, 'fkXg$n{%emz6(*-`G~g`');

registerOnDrag('hole_controller_left', false, function() {}, function() {
  dragMove('hole_controller_left', 'Z', '=1p3xZ+nxJl3O+|rmKLp', 'MADLfSJb0.7zubEo*-ho');
  setMorphFactor('mechanism_part', 'move_holes', (getObjTransform('hole_controller_left', 'position', 'z') - 0.25) * -2);
  setObjTransform('hole_controller_right', 'position', '', '', getObjTransform('hole_controller_left', 'position', 'z'), false);
...
registerOnDrag('shelf_slider_height_top', false, function() {}, function() {
  dragMove('shelf_slider_height_top', 'Z', 'X{*({y^^wUV7rl{wKoLN', 'fkXg$n{%emz6(*-`G~g`');
  setMorphFactor('shelf', 'height', (getObjTransform('shelf_slider_height_top', 'position', 'z') - 0.125) * 8);
  setMorphFactor('shelf_wall', 'height', (getObjTransform('shelf_slider_height_top', 'position', 'z') - 0.125) * 8);
  setObjTransform('shelf_slider_height_bottom', 'position', '', '', getObjTransform('shelf_slider_height_top', 'position', 'z') * -1, false);
}, function() {}, 'fkXg$n{%emz6(*-`G~g`');
registerOnDrag('shelf_slider_height_bottom', false, function() {}, function() {
  dragMove('shelf_slider_height_bottom', 'Z', 'z{Er_gY?A=Y+-P_|W0SJ', '$lUIGpIB;d0ku^ZF!H{8');
  setMorphFactor('shelf', 'height', (getObjTransform('shelf_slider_height_bottom', 'position', 'z') + 0.125) * -8);
  setMorphFactor('shelf_wall', 'height', (getObjTransform('shelf_slider_height_bottom', 'position', 'z') + 0.125) * -8);
  setObjTransform('shelf_slider_height_top', 'position', '', '', getObjTransform('shelf_slider_height_bottom', 'position', 'z') * -1, false);
}, function() {}, '$lUIGpIB;d0ku^ZF!H{8');
registerOnDrag('shelf_slider_width_right', false, function() {}, function() {
  dragMove('shelf_slider_width_right', 'X', 'cJx/UZ}.QZE{`=C==/9N', '2.m.KR@zb-smZR?uRm:K');
  setMorphFactor('shelf', 'width', (getObjTransform('shelf_slider_width_right', 'position', 'x') - 0.25) * 4);
  setMorphFactor('horizontal_shelf', 'width', (getObjTransform('shelf_slider_width_right', 'position', 'x') - 0.25) * 4);
  setMorphFactor('shelf_wall', 'width', (getObjTransform('shelf_slider_width_right', 'position', 'x') - 0.25) * 4);
  setMaterialValue('self_wall', 'horizontal_shelf_width', (getObjTransform('shelf_slider_width_right', 'position', 'x') - 0.25) * 4 + 0.9);
  setObjTransform('shelf_slider_width_left', 'position', getObjTransform('shelf_slider_width_right', 'position', 'x') * -1, '', '', false);
}, function() {}, '2.m.KR@zb-smZR?uRm:K');
registerOnDrag('shelf_slider_width_left', false, function() {}, function() {
  dragMove('shelf_slider_width_left', 'X', '=ET.4dd%lLTY`T*oJK4$', 'B@Qh()Jbo~)`!eu*a[kR');
  setMorphFactor('shelf', 'width', (getObjTransform('shelf_slider_width_left', 'position', 'x') + 0.25) * -4);
  setMorphFactor('horizontal_shelf', 'width', (getObjTransform('shelf_slider_width_left', 'position', 'x') + 0.25) * -4);
  setMorphFactor('shelf_wall', 'width', (getObjTransform('shelf_slider_width_left', 'position', 'x') + 0.25) * -4);
  setMaterialValue('self_wall', 'horizontal_shelf_width', (getObjTransform('shelf_slider_width_left', 'position', 'x') + 0.25) * -4 + 0.9);
  setObjTransform('shelf_slider_width_right', 'position', getObjTransform('shelf_slider_width_left', 'position', 'x') * -1, '', '', false);
}, function() {}, 'B@Qh()Jbo~)`!eu*a[kR');
registerOnDrag('shelf_slider_depth', false, function() {}, function() {
  dragMove('shelf_slider_depth', 'Y', '*uaucKkD(1@5It6uw9*,', 'Kn8?-N{KPiDfa5w{Y^q]');
  setMorphFactor('shelf', 'depth', (getObjTransform('shelf_slider_depth', 'position', 'y') + 0.1) * 5 * -1);
  setMorphFactor('horizontal_shelf', 'depth', (getObjTransform('shelf_slider_depth', 'position', 'y') + 0.1) * 5 * -1);
  setObjTransform(['shelf_slider_width_left', 'shelf_slider_width_right', 'shelf_slider_height_top', 'shelf_slider_height_bottom'], 'position', '', (getObjTransform('shelf_slider_depth', 'position', 'y') + 0.1) / 2, '', false);
...
registerOnDrag('ring_slider_size', false, function() {}, function() {
  dragMove('ring_slider_size', 'Z', 'EC6dn5~VN-2M^jSJMDRq', 'O(xR)ugIAg.6OA%dw0Rx');
  setMorphFactor('ring', 'size', (getObjTransform('ring_slider_size', 'position', 'z') - 0.25) * 5);
...
eventHTMLElem('click', 'button_ring_1', true, function(event) {
  if (getMorphFactor('ring', 'ring_2') == 1) {
    ...
    animateParam(1, 0, 1, 'Linear', 'InOut', 0, false,
        function() {
      setMorphFactor('ring', 'ring_2', _pGlob.animateParamUpdate);
      setMaterialValue('gold', 'ring_2_ao', _pGlob.animateParamUpdate);
    },
        function() {});
    ...
    animateParam(1, 0, 1, 'Linear', 'InOut', 0, false,
        function() {
      setMorphFactor('ring', 'ring_3', _pGlob.animateParamUpdate);
      setMaterialValue('gold', 'ring_3_ao', _pGlob.animateParamUpdate);
    },
        function() {});
